---
title: "Proportionality analysis of compositional microbiome data, alternative to absolute correlation methods"
...
-   Demonstrate proportionality analysis of a real microbiome dataset
    using `propr` package
...
## Evaluate precision and recall of proportionality 
...
prop.table(table(abs_rel_coef2$is.sig_sp, abs_rel_coef2$is.sig_propr), margin = 1) 

# chi square test 
chisq.test(table(abs_rel_coef2$is.sig_sp, abs_rel_coef2$is.sig_propr)) 
