...
The [igraph package](https://igraph.org/r/doc/aaa-igraph-package.html) implement visualization of the theta_d object. 
...
proportionality in `Obese` compared to `Lean` (i.e., sudden
coordination in `Obese`) while green edges represent a lack of
proportionality in `Obese` compared to `Lean` (i.e., no coordination in
`Obese`).
